...
then the linearized relative inaccuracy $u_{d,rel}$ magically simplifies to $r$. \textit{Mathematica 9 Student Edition} was used for aid in algebraic manipulation and simplification of the equations.
