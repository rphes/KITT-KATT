...
\end{align*}
Choosing the interval length $I$ twice the peak spacing $L$ makes sense, because then a correct recording is guaranteed. Therefore, we chose our recording time to be twice the peak interval length.
\end{document}