...
A more general discrete function can be expressed as a sum of $k$ discrete impulses with a time delay, thus yielding as a response the sum of multiple delayed step functions ($u[n-\tau]$) with amplitudes of $a^{n-\tau}$.
