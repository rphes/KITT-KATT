...
\label{ass1-rep-12-13}
Assuming the speed of sound to be \SI{340}{m/s}, it will take $0.01/340 = \SI{29.4}{\micro s}$ to travel a distance of \SI{1}{cm}. If we would want to measure with a resolution of \SI{1}{cm}, we would need to be able to measure a time difference of arrival of half this time-span, which means a receiver capable of a sampling rate $F_s > (29.4 \times 10^{-6} / 2)^{-1} = \SI{68}{kHz}$.
