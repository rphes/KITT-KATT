...
Given the above, we can use \texttt{MATLAB} to create a Bode (magnitude) plot for $V(z,j\omega)\mid_{z=l=1.2}$, which can be found in Figure~\ref{fig:ass1-esd}. The code can be found in the appendix. --insert appendix, blaat about figure--
