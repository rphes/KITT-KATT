...
to for example the rectifier used during EPO1 at \SI{50}{Hz}).
\\
The charging system is also equiped with a compensation circuit as shown in Figure~\ref{fig:ass2_eq_circ}. While designing this we first determined the transfer function.
