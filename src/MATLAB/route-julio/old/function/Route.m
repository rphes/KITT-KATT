function [distance, ref_hoek] = Route(x0_loc, y0_loc, x_loc, y_loc, waypoint_x, waypoint_y)
%ROUTE This is a function calling all other functions in the right order
