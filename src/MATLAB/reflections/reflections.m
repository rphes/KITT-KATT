...
XTicks = 'auto';
YTicks = 'auto';
outputPath = 'output/ass-1-report-1-impulse-response-2-copies-beta-1'; % 'off' to disable outputting
graphTitle = 'Low resolution impulse response for \beta = 1';
yLabel = 'Amplitude';
xLabel = 'Time (ms)';
xLim = 'auto';
yLim = 'auto';
...
MarkerSize = [5;5];
legendText = {'Sent signal x(t)','Received signal y(t)'};
makeLegend = 'yes';
legendLocation = 'northEast';
logX = 0;
...
XTicks = 'auto';
YTicks = 'auto';
outputPath = 'output/ass-1-report-1-system-response-2-copies-beta-1'; % 'off' to disable outputting
graphTitle = 'Low resolution system response for \beta = 1';
yLabel = 'Amplitude';
xLabel = 'Time (ms)';
xLim = 'auto';
yLim = 'auto';
